...
int main()
{
  ...
  for (int i = 0; i <= depth; i++)
  {
    ...
    //Save dens mat
    char dir_tosave[MAX_LINE_LENGTH] = "C:/Users/maria/Desktop/Entropy_Benchmarking/Entropy_Benchmarking/Entropy_Benchmarking/Code/Quest_Q5_D15_DensityMatrix_NoiseModel/Data/DensMat_qc_Q5_D";
