"""
PROCESSING (from measurement outcomes saved in csv files to purity/entropy estimates saved to pkl files)
----------------------------------------------------------------------------------
...
from libMetric import compute_metrics_from_measures
...
# ==================================================================
# Get metrics
metrics = compute_metrics_from_measures(experiment_params, verbose=False)
