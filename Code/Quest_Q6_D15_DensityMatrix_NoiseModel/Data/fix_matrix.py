...
for i in range(1,16):
    filepath = "DensMat_qc_Q6_D"+str(i)+".txt"
    ...
    #C:\Users\maria\Desktop\Entropy_Benchmarking\Entropy_Benchmarking\Entropy_Benchmarking\Code\Quest_Q2_D15_DensityMatrix_NoiseModel\Data_bigendian\DensMat_qc_Q2_D1.txt
    filename= "C:/Users/maria/Desktop/Entropy_Benchmarking/Entropy_Benchmarking/Entropy_Benchmarking/Code/Quest_Q6_D15_DensityMatrix_NoiseModel/data_fixed/DensMat_qc_Q6_D"+str(i)+".csv"
