...
for i in range(16):
    filepath = "DensMat_qc_Q5_D"+str(i)+".txt"
    ...
    filename= "C:/Users/maria/Desktop/Entropy_Benchmarking/Entropy_Benchmarking/Entropy_Benchmarking/Code/Quest_Q5_D15_DensityMatrix_NoiseModel/data_fixed/DensMat_qc_Q5_D"+str(i)+".csv"
