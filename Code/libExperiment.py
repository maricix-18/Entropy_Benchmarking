...
class ExperimentParams:
    def __init__(self, backend_params, circuit_params, noise_params, protocol_params, seed, timestamp=None, csv_files=dict(), metrics_file="", metrics_estimation_file=""):
        ...
        self.metrics_estimation_file = metrics_estimation_file
    def to_dict(self):
        temp = dict()
        temp['seed'] = self.seed
    ...
    def from_dict(temp):
        ...
        return ExperimentParams(backend_params, circuit_params, noise_params, protocol_params, temp['seed'], temp['timestamp'], temp['csv_files'], temp['metrics_file'], temp['metrics_estimation_file'])
